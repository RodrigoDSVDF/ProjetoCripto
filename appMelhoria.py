...
if escolha == 'Home':
    ...
    # Removendo a imagem daqui para evitar repetição
    ...
    if st.button(f'Analisar {moeda_selecionada}'):
        ...
        with tab7:
            # Ajustando para exibir a volatilidade em porcentagem real
            ...
            for moeda in criptomoedas:
                ...
                # Exibindo a volatilidade em porcentagem real
            ...
            # Formatando os valores de volatilidade para exibir como porcentagem
            df_volatilidade['Volatilidade Percentual'] = df_volatilidade['Volatilidade Percentual'].map('{:.2f}%'.format)
